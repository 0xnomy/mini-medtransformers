...
print("-" * 80)
result = subprocess.run([sys.executable, "step4_augment_conversational_MedQ.py"], cwd=".")
...
print("-" * 80)
result = subprocess.run([sys.executable, "step6_validate_custom_questions.py"], cwd=".")
if result.returncode != 0:
