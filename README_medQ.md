...
python step4_augment_conversational_MedQ.py
python step5_train_model_MedQ.py --use_conversational --validate_on_custom
python step6_validate_custom_questions_MedQ.py
```

### Quick Run (all steps)
```bash
python improve_conversational_MedQ.py
```
...
python step5_train_model_MedQ.py

# With conversational data
python step5_train_model_MedQ.py --use_conversational
